...
const Header = () => {
  return (
    <div className='flex flex-col'>
      <div className='h-6 lg:h-8 bg-blue-900 text-center flex items-center justify-center'>
        ...
        <div className='container mx-auto'>
          <div className='flex flex-row justify-between items-center text-xs text-slate-500 p-3'>
            ...
            <div className='hidden lg:block text-center'>
              <p>100% Secure delivery without contact</p>
            </div>
            <div className='flex flex-row gap-2'>
              <span>Need Help? Call Us:</span>
              <span className='font-semibold'>+ 0500 551122</span>
            </div>
          </div>
        </div>
      </div>
